...
| 30 | `C8` | 通用/上游应用同步 | 合并 `origin/beta` 在 C7 之后的片头片尾跳过、播放器生命周期、阅读器路由和更新包签名校验变更，并复审当前未推送改动 | **验证完成，待提交**：目标 `308694aaadd59d9d1ef230bded83cf84dafa114c`；基线 `b235cee7408b8531c257f94fb65b0b4f4068d4c2`；合并提交 `5cf2f2e7fddd48454d10b86c27cc9f02e979098a` 已保留；Updater、IntroSkip、阅读器和 TMDB 修复已完成，73 项定向测试及 Mobile/Leanback Arm64 Java 编译通过；待 task guard 原子修复提交、恢复 tag、推送和拉取 | [C8-beta-sync.md](C8-beta-sync.md) |
