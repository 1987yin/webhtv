...
| 29 | `C7` | 通用/上游应用同步 | 合并 `origin/beta` 在 C6 之后的 TMDB 手动匹配持久化、标题锚点隔离和读改写竞态修复 | **实施中**：目标 `7db1b9d188e27877154757528d441150142b90ed`；6 个完整来源 commit 已记录，待合并和定向 Java 验证 | [C7-beta-sync.md](C7-beta-sync.md) |
